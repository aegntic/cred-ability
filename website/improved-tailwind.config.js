  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'electric-gradient': 'linear-gradient(90deg, #29B6F6, #0288D1)',
        'gold-gradient': 'linear-gradient(90deg, #FFC107, #FF8F00)',
      ...
      boxShadow: {
        ...
        'premium': '0 10px 30px rgba(0, 0, 0, 0.5), inset 0 1px 1px rgba(255, 255, 255, 0.1)',
      },
      animation: {
